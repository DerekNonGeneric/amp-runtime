(self.AMP=self.AMP||[]).push({n:"amp-reach-player",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpReachPlayer = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpReachPlayer, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpReachPlayer(element) {
    babelHelpers.classCallCheck(this, AmpReachPlayer);
  ...
  AmpReachPlayer.prototype.preconnectCallback = function preconnectCallback(opt_onLayout) {
    this.preconnect.url('https://player-cdn.beachfrontmedia.com', opt_onLayout);
  };

  /** @override */

  AmpReachPlayer.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpReachPlayer.prototype.layoutCallback = function layoutCallback() {
    var embedId = this.element.getAttribute('data-embed-id') || 'default';
...
},{"../../../src/layout":2}],2:[function(require,module,exports){
...
//# sourceMappingURL=amp-reach-player-0.1.max.js.map
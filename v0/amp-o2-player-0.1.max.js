(self.AMP=self.AMP||[]).push({n:"amp-o2-player",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpO2Player = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpO2Player, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpO2Player(element) {
    babelHelpers.classCallCheck(this, AmpO2Player);
  ...
  AmpO2Player.prototype.preconnectCallback = function preconnectCallback(onLayout) {
    this.preconnect.url(this.domain_, onLayout);
  };

  /** @override */

  AmpO2Player.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpO2Player.prototype.buildCallback = function buildCallback() {
    this.pid_ = _srcLog.user().assert(this.element.getAttribute('data-pid'), 'data-pid attribute is required for <amp-o2-player> %s', this.element);

    this.bcid_ = _srcLog.user().assert(this.element.getAttribute('data-bcid'), 'data-bcid attribute is required for <amp-o2-player> %s', this.element);
    ...
    var env = this.element.getAttribute('data-env');

    this.domain_ = 'https://delivery.' + (env != 'stage' ? '' : 'dev.') + 'vidible.tv';
  ...
  AmpO2Player.prototype.layoutCallback = function layoutCallback() {
    _srcLog.user().assert(this.pid_, 'data-pid attribute is required for <amp-o2-player> %s', this.element);
    _srcLog.user().assert(this.bcid_, 'data-bcid attribute is required for <amp-o2-player> %s', this.element);
  ...
  AmpO2Player.prototype.pauseCallback = function pauseCallback() {

...
var _buildAmpFxFlyingCarpet01Css = require('../../../build/amp-fx-flying-carpet-0.1.css');
...
var AmpFlyingCarpet = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpFlyingCarpet, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpFlyingCarpet(element) {
    babelHelpers.classCallCheck(this, AmpFlyingCarpet);
  ...
  AmpFlyingCarpet.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return layout == _srcLayout.Layout.FIXED_HEIGHT;
  };

  /** @override */

  AmpFlyingCarpet.prototype.buildCallback = function buildCallback() {
    var _this = this;
  ...
  AmpFlyingCarpet.prototype.onLayoutMeasure = function onLayoutMeasure() {
    var _this2 = this;

    var width = this.getLayoutWidth();
    this.getVsync().mutate(function () {
      _srcStyle.setStyle(_this2.container_, 'width', width, 'px');
    });
  };

  /** @override */

  AmpFlyingCarpet.prototype.viewportCallback = function viewportCallback(inViewport) {
  ...
  AmpFlyingCarpet.prototype.assertPosition_ = function assertPosition_() {
    ...
    _srcLog.user().assert(layoutBox.top >= minTop, '<amp-fx-flying-carpet> elements must be positioned after the 75% of' + ' first viewport: %s Current position: %s. Min: %s', this.element, layoutBox.top, minTop);
    _srcLog.user().assert(layoutBox.top <= maxTop, '<amp-fx-flying-carpet> elements must be positioned before the last ' + 'viewport: %s Current position: %s. Max: %s', this.element, layoutBox.top, maxTop);
  };

  /** @override */

  AmpFlyingCarpet.prototype.layoutCallback = function layoutCallback() {
    try {
    ...
    _srcEventHelper.listen(this.element, 'amp:built', this.layoutBuiltChild_.bind(this));
  ...
  AmpFlyingCarpet.prototype.layoutBuiltChild_ = function layoutBuiltChild_(event) {
    var child = _srcLog.dev().assertElement(event.target);
  ...
  AmpFlyingCarpet.prototype.collapsedCallback = function collapsedCallback(child) {
  ...
  AmpFlyingCarpet.prototype.visibileChildren_ = function visibileChildren_(nodes) {
...
AMP.registerElement('amp-fx-flying-carpet', AmpFlyingCarpet, _buildAmpFxFlyingCarpet01Css.CSS);

},{"../../../build/amp-fx-flying-carpet-0.1.css":1,"../../../src/event-helper":4,"../../../src/layout":5,"../../../src/log":6,"../../../src/style":10}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"./event-helper-listen":3,"./log":6}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":6,"./string":9,"./style":10,"./types":11}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":8,"./mode-object":7,"./types":11}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":9,"./url-parse-query-string":12}],9:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":9,"./utils/object.js":13}],11:[function(require,module,exports){
exports.__esModule = true;

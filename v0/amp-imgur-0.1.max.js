(self.AMP=self.AMP||[]).push({n:"amp-imgur",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpImgur = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpImgur, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpImgur(element) {
    babelHelpers.classCallCheck(this, AmpImgur);
  ...
  AmpImgur.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpImgur.prototype.buildCallback = function buildCallback() {
    this.imgurid_ = _srcLog.user().assert(this.element.getAttribute('data-imgur-id'), 'The data-imgur-id attribute is required for <amp-imgur> %s', this.element);
  };

  /** @override */

  AmpImgur.prototype.layoutCallback = function layoutCallback() {
    var iframe = this.element.ownerDocument.createElement('iframe');
    this.iframe_ = iframe;

    this.unlistenMessage_ = _srcEventHelper.listen(this.win, 'message', this.hadleImgurMessages_.bind(this));

    iframe.setAttribute('scrolling', 'no');
    iframe.setAttribute('frameborder', '0');
    iframe.setAttribute('allowfullscreen', 'true');

    iframe.src = 'https://imgur.com/a/' + encodeURIComponent(this.imgurid_) + '/embed?pub=true';
  ...
  AmpImgur.prototype.hadleImgurMessages_ = function hadleImgurMessages_(event) {
  ...
  AmpImgur.prototype.unlayoutCallback = function unlayoutCallback() {
    if (this.iframe_) {
...
},{"../../../src/dom":2,"../../../src/event-helper":4,"../../../src/json":5,"../../../src/layout":6,"../../../src/log":7,"../../../src/string":10,"../../../src/types":12}],2:[function(require,module,exports){
exports.__esModule = true;
...
},{"../third_party/css-escape/css-escape":15,"./log":7,"./string":10}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"./event-helper-listen":3,"./log":7}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":7,"./string":10,"./style":11,"./types":12}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":9,"./mode-object":8,"./types":12}],8:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":10,"./url-parse-query-string":13}],10:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":10,"./utils/object.js":14}],12:[function(require,module,exports){
exports.__esModule = true;
...
},{"../types":12}],15:[function(require,module,exports){
exports.__esModule = true;

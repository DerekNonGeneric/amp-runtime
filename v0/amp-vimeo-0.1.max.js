(self.AMP=self.AMP||[]).push({n:"amp-vimeo",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpVimeo = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpVimeo, _AMP$BaseElement);

  function AmpVimeo() {
    babelHelpers.classCallCheck(this, AmpVimeo);
  ...
  AmpVimeo.prototype.preconnectCallback = function preconnectCallback(onLayout) {
  ...
  AmpVimeo.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpVimeo.prototype.layoutCallback = function layoutCallback() {
    var videoid = _srcLog.user().assert(this.element.getAttribute('data-videoid'), 'The data-videoid attribute is required for <amp-vimeo> %s', this.element);
    // See
  ...
  AmpVimeo.prototype.pauseCallback = function pauseCallback() {

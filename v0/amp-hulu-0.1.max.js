(self.AMP=self.AMP||[]).push({n:"amp-hulu",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpHulu = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpHulu, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpHulu(element) {
    babelHelpers.classCallCheck(this, AmpHulu);
  ...
  AmpHulu.prototype.preconnectCallback = function preconnectCallback() {
    this.preconnect.preload(this.getVideoIframeSrc_());
  };

  /** @override */

  AmpHulu.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpHulu.prototype.layoutCallback = function layoutCallback() {
  ...
  AmpHulu.prototype.unlayoutOnPause = function unlayoutOnPause() {
    return true;
  };

  /** @override */

  AmpHulu.prototype.unlayoutCallback = function unlayoutCallback() {
    if (this.iframe_) {
  ...
  AmpHulu.prototype.buildCallback = function buildCallback() {
    this.eid_ = _srcLog.user().assert(this.element.getAttribute('data-eid'), 'The data-eid attribute is required for <amp-hulu> %s', this.element);
  };

  /** @return {string} */

  AmpHulu.prototype.getVideoIframeSrc_ = function getVideoIframeSrc_() {
    _srcLog.dev().assert(this.eid_);
...
//# sourceMappingURL=amp-hulu-0.1.max.js.map
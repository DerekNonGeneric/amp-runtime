(self.AMP=self.AMP||[]).push({n:"amp-brightcove",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpBrightcove = (function (_AMP$BaseElement) {
  ...
  function AmpBrightcove(element) {
  ...
  AmpBrightcove.prototype.preconnectCallback = function preconnectCallback() {
  ...
  AmpBrightcove.prototype.buildCallback = function buildCallback() {
    this.iframe_ = null;
  };
  ...
  AmpBrightcove.prototype.getIframeSrc_ = function getIframeSrc_() {
    var account = _srcLog.user().assert(this.element.getAttribute('data-account'), 'The data-account attribute is required for <amp-brightcove> %s', this.element);
    var playerid = this.element.getAttribute('data-player') || this.element.getAttribute('data-player-id') || 'default';
    ...
    src = _srcUrl.addParamsToUrl(src, _srcDom.getDataParamsFromAttributes(this.element));
    return src;
  };

  /** @override */

  AmpBrightcove.prototype.mutatedAttributesCallback = function mutatedAttributesCallback(mutations) {
    ...
    if (account !== undefined || playerId !== undefined || playlistId !== undefined || embed !== undefined || videoId !== undefined) {
      if (this.iframe_) {
  ...
  AmpBrightcove.prototype.pauseCallback = function pauseCallback() {
    /*
  ...
  AmpBrightcove.prototype.unlayoutOnPause = function unlayoutOnPause() {
    return true;
  };
  ...
  AmpBrightcove.prototype.unlayoutCallback = function unlayoutCallback() {
    if (this.iframe_) {
...
},{"../../../src/dom":3,"../../../src/layout":4,"../../../src/log":5,"../../../src/url":12}],2:[function(require,module,exports){

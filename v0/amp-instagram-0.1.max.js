(self.AMP=self.AMP||[]).push({n:"amp-instagram",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
exports.__esModule = true;
var CSS = "amp-instagram.amp-instagram-default-framing{border:1px solid #dbdbdb!important}\n/*# sourceURL=/extensions/amp-instagram/0.1/amp-instagram.css*/";
exports.CSS = CSS;
...
var _buildAmpInstagram01Css = require('../../../build/amp-instagram-0.1.css');
...
var AmpInstagram = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpInstagram, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpInstagram(element) {
    babelHelpers.classCallCheck(this, AmpInstagram);
  ...
  AmpInstagram.prototype.preconnectCallback = function preconnectCallback(opt_onLayout) {
    // See
    ...
    this.preconnect.url('https://instagram.fsnc1-1.fna.fbcdn.net', opt_onLayout);
  };

  /** @override */

  AmpInstagram.prototype.renderOutsideViewport = function renderOutsideViewport() {
    return false;
  };

  /** @override */

  AmpInstagram.prototype.buildCallback = function buildCallback() {
    this.shortcode_ = _srcLog.user().assert(this.element.getAttribute('data-shortcode') || this.element.getAttribute('shortcode'), 'The data-shortcode attribute is required for <amp-instagram> %s', this.element);
    this.captioned_ = this.element.hasAttribute('data-captioned') ? 'captioned/' : '';
  };

  /** @override */

  AmpInstagram.prototype.createPlaceholderCallback = function createPlaceholderCallback() {
    var placeholder = this.win.document.createElement('div');
    placeholder.setAttribute('placeholder', '');
    var image = this.win.document.createElement('amp-img');
    ...
    image.setAttribute('src', 'https://www.instagram.com/p/' + encodeURIComponent(this.shortcode_) + '/media/?size=l');
  ...
  AmpInstagram.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpInstagram.prototype.layoutCallback = function layoutCallback() {
    var _this = this;

    var iframe = this.element.ownerDocument.createElement('iframe');
    this.iframe_ = iframe;

    this.unlistenMessage_ = _srcEventHelper.listen(this.win, 'message', this.handleInstagramMessages_.bind(this));
    ...
    iframe.src = 'https://www.instagram.com/p/' + encodeURIComponent(this.shortcode_) + '/embed/' + this.captioned_ + '?cr=1&v=7';
  ...
  AmpInstagram.prototype.handleInstagramMessages_ = function handleInstagramMessages_(event) {
    var _this2 = this;

    if (event.origin != 'https://www.instagram.com' || event.source != this.iframe_.contentWindow) {
      return;
    }
    ...
    if (data.type == 'MEASURE' && data.details) {
      (function () {
        ...
        _this2.getVsync().measure(function () {
          if (_this2.iframe_ && _this2.iframe_. /*OK*/offsetHeight !== height) {
            // Height returned by Instagram includes header, so
            // subtract 48px top padding
            _this2.attemptChangeHeight(height - (PADDING_TOP + PADDING_BOTTOM))['catch'](function () {});
          }
        });
      })();
    }
  ...
  AmpInstagram.prototype.unlayoutOnPause = function unlayoutOnPause() {
    return true;
  };

  /** @override */

  AmpInstagram.prototype.unlayoutCallback = function unlayoutCallback() {
    if (this.iframe_) {
...
AMP.registerElement('amp-instagram', AmpInstagram, _buildAmpInstagram01Css.CSS);

},{"../../../build/amp-instagram-0.1.css":1,"../../../src/dom":3,"../../../src/event-helper":5,"../../../src/json":6,"../../../src/layout":7,"../../../src/log":8,"../../../src/string":11,"../../../src/style":12,"../../../src/types":13}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"../third_party/css-escape/css-escape":16,"./log":8,"./string":11}],4:[function(require,module,exports){
exports.__esModule = true;
...
},{"./event-helper-listen":4,"./log":8}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./types":13}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":8,"./string":11,"./style":12,"./types":13}],8:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":10,"./mode-object":9,"./types":13}],9:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":11,"./url-parse-query-string":14}],11:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":11,"./utils/object.js":15}],13:[function(require,module,exports){
exports.__esModule = true;
...
},{"../types":13}],16:[function(require,module,exports){
exports.__esModule = true;
...
//# sourceMappingURL=amp-instagram-0.1.max.js.map
(self.AMP=self.AMP||[]).push({n:"amp-kaltura-player",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpKaltura = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpKaltura, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpKaltura(element) {
    babelHelpers.classCallCheck(this, AmpKaltura);
  ...
  */
  ...
  AmpKaltura.prototype.preconnectCallback = function preconnectCallback(opt_onLayout) {
    this.preconnect.url('https://cdnapisec.kaltura.com', opt_onLayout);
  };

  /** @override */

  AmpKaltura.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpKaltura.prototype.buildCallback = function buildCallback() {
    this.partnerId_ = _srcLog.user().assert(this.element.getAttribute('data-partner'), 'The data-partner attribute is required for <amp-kaltura-player> %s', this.element);
  ...
  AmpKaltura.prototype.layoutCallback = function layoutCallback() {
    var uiconfId = this.element.getAttribute('data-uiconf') || this.element.getAttribute('data-uiconf-id') || 'default';
    var iframe = this.element.ownerDocument.createElement('iframe');
    var src = 'https://cdnapisec.kaltura.com/p/' + encodeURIComponent(this.partnerId_) + '/sp/' + encodeURIComponent(this.partnerId_) + '00/embedIframeJs/uiconf_id/' + encodeURIComponent(uiconfId) + '/partner_id/' + encodeURIComponent(this.partnerId_) + '?iframeembed=true&playerId=kaltura_player_amp&entry_id=' + encodeURIComponent(this.entryId_);
    var params = _srcDom.getDataParamsFromAttributes(this.element, function (key) {
  ...
  AmpKaltura.prototype.createPlaceholderCallback = function createPlaceholderCallback() {
    ...
    var src = 'https://cdnapisec.kaltura.com/p/' + encodeURIComponent(this.partnerId_) + '/thumbnail/entry_id/' + encodeURIComponent(this.entryId_);
    if (width) {
      src += '/width/' + width;
    }
    if (height) {
  ...
  AmpKaltura.prototype.pauseCallback = function pauseCallback() {
...
},{"../../../src/dom":3,"../../../src/layout":4,"../../../src/log":5,"../../../src/url":12,"../../../src/utils/object":13}],2:[function(require,module,exports){
...
},{"../third_party/css-escape/css-escape":14,"./log":5,"./string":8}],4:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":5,"./string":8,"./style":9,"./types":10}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":7,"./mode-object":6,"./types":10}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":8,"./url-parse-query-string":11}],8:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":8,"./utils/object.js":13}],10:[function(require,module,exports){
exports.__esModule = true;
...
},{"./config":2,"./log":5,"./mode":7,"./string":8,"./types":10,"./url-parse-query-string":11}],13:[function(require,module,exports){
exports.__esModule = true;
exports.map = map;
exports.dict = dict;
...
},{"../types":10}],14:[function(require,module,exports){
exports.__esModule = true;
...
//# sourceMappingURL=amp-kaltura-player-0.1.max.js.map
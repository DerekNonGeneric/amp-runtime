(self.AMP=self.AMP||[]).push({n:"amp-gfycat",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpGfycat = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpGfycat, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpGfycat(element) {
    babelHelpers.classCallCheck(this, AmpGfycat);
  ...
  AmpGfycat.prototype.preconnectCallback = function preconnectCallback(opt_onLayout) {
    // Gfycat iframe
  ...
  AmpGfycat.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpGfycat.prototype.layoutCallback = function layoutCallback() {
    var gfyid = _srcLog.user().assert(this.element.getAttribute('data-gfyid'), 'The data-gfyid attribute is required for <amp-gfycat> %s', this.element);
    var noautoplay = this.element.hasAttribute('noautoplay');

    var iframe = this.element.ownerDocument.createElement('iframe');
    iframe.setAttribute('frameborder', '0');

    var src = 'https://gfycat.com/ifr/' + encodeURIComponent(gfyid);
    if (noautoplay) {
      src += '?autoplay=0';
    }
  ...
  AmpGfycat.prototype.pauseCallback = function pauseCallback() {

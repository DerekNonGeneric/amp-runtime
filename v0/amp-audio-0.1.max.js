(self.AMP=self.AMP||[]).push({n:"amp-audio",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpAudio = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpAudio, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpAudio(element) {
    babelHelpers.classCallCheck(this, AmpAudio);
  ...
  AmpAudio.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return layout == _srcLayout.Layout.FIXED || layout == _srcLayout.Layout.FIXED_HEIGHT;
  };

  /** @override */

  AmpAudio.prototype.layoutCallback = function layoutCallback() {
    ...
    this.propagateAttributes(['src', 'autoplay', 'muted', 'loop', 'aria-label', 'aria-describedby', 'aria-labelledby'], audio);
  ...
  AmpAudio.prototype.pauseCallback = function pauseCallback() {
    if (this.audio_) {
      this.audio_.pause();
    }
  };
...
},{"../../../src/layout":3,"../../../src/log":4,"../../../src/url":11}],2:[function(require,module,exports){
exports.__esModule = true;
/**
...
},{"./config":2,"./log":4,"./mode":6,"./string":7,"./types":9,"./url-parse-query-string":10}],12:[function(require,module,exports){
exports.__esModule = true;
exports.map = map;
exports.dict = dict;

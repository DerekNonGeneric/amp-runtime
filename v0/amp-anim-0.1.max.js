(self.AMP=self.AMP||[]).push({n:"amp-anim",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var AmpAnim = (function (_AMP$BaseElement) {
  ...
  AmpAnim.prototype.buildCallback = function buildCallback() {
    this.propagateAttributes(['alt', 'aria-label', 'aria-describedby', 'aria-labelledby'], this.img_);
    ...
    if (this.element.getAttribute('role') == 'img') {
      ...
      _srcLog.user().error('AMP-ANIM', 'Setting role=img on amp-anim elements ' + 'breaks screen readers. Please just set alt or ARIA attributes, ' + 'they will be correctly propagated for the underlying <img> ' + 'element.');
    }
  ...
  AmpAnim.prototype.viewportCallback = function viewportCallback(unusedInViewport) {
    if (!this.hasLoaded_) {
  ...
  AmpAnim.prototype.unlayoutCallback = function unlayoutCallback() {
  ...
  AmpAnim.prototype.updateImageSrc_ = function updateImageSrc_() {
    ...
    return this.loadPromise(this.img_)['catch'](function (error) {
      if (!_this.img_.getAttribute('src')) {
        return;
      }
      throw error;
    });
...
},{"../../../src/layout":2,"../../../src/log":3,"../../../src/srcset":6,"../../../src/style":8}],2:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":3,"./string":7,"./style":8,"./types":9}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":7,"./url-parse-query-string":10}],6:[function(require,module,exports){
exports.__esModule = true;

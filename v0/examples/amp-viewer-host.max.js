...
var AmpViewerHost = (function () {
  ...
  function AmpViewerHost(win, ampIframe, frameOrigin, messageHandler, opt_logsId, opt_isWebview, opt_isHandshakePoll) {
    babelHelpers.classCallCheck(this, AmpViewerHost);
  ...
  AmpViewerHost.prototype.initiateHandshake_ = function initiateHandshake_() {
    var _this = this;
    ...
    if (this.ampIframe_) {
      (function () {
        ...
        var message = {
          app: _messagingMessaging.APP,
          name: 'handshake-poll'
        };
        message = _this.isWebview_ ? JSON.stringify(message) : message;
        _this.ampIframe_.contentWindow. /*OK*/postMessage(message, '*', [channel.port2]);
  ...
  AmpViewerHost.prototype.waitForHandshake_ = function waitForHandshake_(targetOrigin) {
    ...
    var listener = (function (event) {
      if (event.origin == targetOrigin && this.isChannelOpen_(event.data) && (!event.source || event.source == target)) {
        ...
        unlisten();
        var port = new _messagingMessaging.WindowPortEmulator(this.win, targetOrigin, target);
        this.completeHandshake_(port, event.data.requestid);
      }
    }).bind(this);
    unlisten = _srcEventHelper.listen(this.win, 'message', listener);
  };
  ...
  AmpViewerHost.prototype.completeHandshake_ = function completeHandshake_(port, requestId) {
    var message = {
      app: _messagingMessaging.APP,
      requestid: requestId,
      type: _messagingMessaging.MessageType.RESPONSE
    };
    ...
    this.messaging_ = new _messagingMessaging.Messaging(this.win, port);
  ...
  AmpViewerHost.prototype.isChannelOpen_ = function isChannelOpen_(eventData) {
    return eventData.app == _messagingMessaging.APP && eventData.name == CHANNEL_OPEN_MSG;
  };
  ...
  AmpViewerHost.prototype.sendRequest = function sendRequest(type, data, awaitResponse) {
  ...
  AmpViewerHost.prototype.log = function log() {
...
},{"../../../../src/event-helper":4,"../../../../third_party/babel/custom-babel-helpers":12,"../messaging/messaging":2}],2:[function(require,module,exports){
exports.__esModule = true;
...
},{"../../../../src/json":5}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"./types":10}],6:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":8,"./mode-object":7,"./types":10}],7:[function(require,module,exports){
exports.__esModule = true;
...
function getRtvVersion(win, isLocalDev) {
  ...
  // Currently `123456789` and thus `mode.version` contain only
  // major version. The full version however must also carry the minor version.
  // We will default to production default `01` minor version for now.
  // TODO(erwinmombay): decide whether 123456789 should contain
  // minor version.
  return '01' + version;
}
...
},{"./string":9,"./url-parse-query-string":11}],9:[function(require,module,exports){
exports.__esModule = true;

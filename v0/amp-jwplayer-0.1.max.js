(self.AMP=self.AMP||[]).push({n:"amp-jwplayer",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpJWPlayer = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpJWPlayer, _AMP$BaseElement);

  /** @param {!AmpElement} element */

  function AmpJWPlayer(element) {
    babelHelpers.classCallCheck(this, AmpJWPlayer);
  ...
  AmpJWPlayer.prototype.preconnectCallback = function preconnectCallback(onLayout) {
  ...
  AmpJWPlayer.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpJWPlayer.prototype.buildCallback = function buildCallback() {
    this.contentid_ = _srcLog.user().assert(this.element.getAttribute('data-playlist-id') || this.element.getAttribute('data-media-id'), 'Either the data-media-id or the data-playlist-id ' + 'attributes must be specified for <amp-jwplayer> %s', this.element);

    this.playerid_ = _srcLog.user().assert(this.element.getAttribute('data-player-id'), 'The data-player-id attribute is required for <amp-jwplayer> %s', this.element);
  };

  /** @override */

  AmpJWPlayer.prototype.layoutCallback = function layoutCallback() {
    var iframe = this.element.ownerDocument.createElement('iframe');
    var src = 'https://content.jwplatform.com/players/' + encodeURIComponent(this.contentid_) + '-' + encodeURIComponent(this.playerid_) + '.html';
  ...
  AmpJWPlayer.prototype.pauseCallback = function pauseCallback() {
  ...
  AmpJWPlayer.prototype.unlayoutCallback = function unlayoutCallback() {
    if (this.iframe_) {
  ...
  AmpJWPlayer.prototype.createPlaceholderCallback = function createPlaceholderCallback() {
    if (!this.element.hasAttribute('data-media-id')) {
      return;
    }
    var placeholder = this.win.document.createElement('amp-img');
    placeholder.setAttribute('src', 'https://content.jwplatform.com/thumbs/' + encodeURIComponent(this.contentid_) + '-720.jpg');
...
},{"../../../src/dom":2,"../../../src/layout":3,"../../../src/log":4}],2:[function(require,module,exports){
...
},{"../third_party/css-escape/css-escape":12,"./log":4,"./string":7}],3:[function(require,module,exports){
exports.__esModule = true;
...
},{"./log":4,"./string":7,"./style":8,"./types":9}],4:[function(require,module,exports){
exports.__esModule = true;
...
},{"./mode":6,"./mode-object":5,"./types":9}],5:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":7,"./url-parse-query-string":10}],7:[function(require,module,exports){
exports.__esModule = true;
...
},{"./string":7,"./utils/object.js":11}],9:[function(require,module,exports){
exports.__esModule = true;
...
},{"../types":9}],12:[function(require,module,exports){
exports.__esModule = true;
...
//# sourceMappingURL=amp-jwplayer-0.1.max.js.map
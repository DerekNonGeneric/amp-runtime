(self.AMP=self.AMP||[]).push({n:"amp-izlesene",v:"1499663230322",f:(function(AMP){(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
var AmpIzlesene = (function (_AMP$BaseElement) {
  babelHelpers.inherits(AmpIzlesene, _AMP$BaseElement);

  function AmpIzlesene(element) {
    babelHelpers.classCallCheck(this, AmpIzlesene);
  ...
  AmpIzlesene.prototype.preconnectCallback = function preconnectCallback(opt_onLayout) {
  ...
  AmpIzlesene.prototype.isLayoutSupported = function isLayoutSupported(layout) {
    return _srcLayout.isLayoutSizeDefined(layout);
  };

  /** @override */

  AmpIzlesene.prototype.buildCallback = function buildCallback() {
    this.videoid_ = _srcLog.user().assert(this.element.getAttribute('data-videoid'), 'The data-videoid attribute is required for <amp-izlesene> %s', this.element);
  };

  /** @return {string} */

  AmpIzlesene.prototype.getVideoIframeSrc_ = function getVideoIframeSrc_() {
  ...
  AmpIzlesene.prototype.layoutCallback = function layoutCallback() {
  ...
  AmpIzlesene.prototype.pauseCallback = function pauseCallback() {
    if (this.iframe_ && this.iframe_.contentWindow) {
      this.iframe_.contentWindow. /*OK*/postMessage(_srcUtilsObject.dict({
        'command': 'pause'
      }), '*');
    }
  };
